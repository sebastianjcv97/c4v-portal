...
const thumb = (key) => `<svg viewBox="0 0 200 120" fill="none" stroke="#C62828" stroke-width="3" stroke-linejoin="round" stroke-linecap="round">${THUMBS[key] || '<rect x="60" y="40" width="80" height="40" rx="6"/>'}</svg>`;

// Sello del Certificado de Calidad C4V (de P2/COMUNICACION.md)
const SEAL = `<svg viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Certificado de Calidad C4V"><circle cx="100" cy="100" r="96" fill="#F4EFE6" stroke="#C62828" stroke-width="5"/><circle cx="100" cy="100" r="84" fill="none" stroke="#C62828" stroke-width="1.5" stroke-dasharray="2 4"/><text x="100" y="54" text-anchor="middle" font-family="Manrope, sans-serif" font-size="12" font-weight="700" letter-spacing="2" fill="#8E1F1F">CERTIFICADO</text><text x="100" y="70" text-anchor="middle" font-family="Manrope, sans-serif" font-size="10" letter-spacing="4" fill="#1F1F1F">DE CALIDAD</text><text x="100" y="121" text-anchor="middle" font-family="'Unbounded', sans-serif" font-size="38" font-weight="800" fill="#C62828">C4V</text><text x="100" y="150" text-anchor="middle" font-family="Manrope, sans-serif" font-size="8.5" font-weight="600" letter-spacing="1.5" fill="#1F1F1F">PROBADA · CALIBRADA · LISTA</text></svg>`;
